                        ...
                        child: FlatButton(
                          onPressed: () {
                            ...
                            if (noKontrol) {
                              ...
                              _veriGonder(
                                  "16", "22", noVeri, cikisVeri, "0", "0");
                              dbHelper.veriYOKSAekleVARSAguncelle(
                                  17, "ok", noVeri, cikisVeri, "0");
  ...
  Future _degergiris2X2X0() async {
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return DegerGiris2X2X0.Deger(_onlarklepe, _birlerklepe, _onlarOut,
            _birlerOut, _degerNo, _oran1, dilSecimi,"tv40");
      },
    ).then((val) {
