  ...
  _satirlar(List<Map> satirlar) {
    ...
    if (dbSatirSayisi > 2) {
      ...
      satirlar[2]["veri1"] == "1"
          ...
          : satirlar[2]["veri1"] == "2"
              ? kumesTuruIndex = 2
              : satirlar[2]["veri1"] == "3" ? kumesTuruIndex = 3 : 3;
      //kumesTuruIndex=int.parse(satirlar[2]['veri1']);
      print('Kümes Türü: ' + satirlar[2]["veri1"]);

      kumesNo = satirlar[2]["veri2"];
      kumesIsmi = satirlar[2]["veri3"];
      sifreAna = satirlar[2]["veri4"];
      print(satirlar[2]["veri4"]);
