...
//++++++++++++++++++++++++++METOTLAR+++++++++++++++++++++++++++++++
  ...
  _satirlar(List<Map> satirlar) {
    ...
    if (dbSatirSayisi > 3) {
      fanAdet = satirlar[3]["veri1"];
      klepeAdet = satirlar[3]["veri2"];
      pedAdet = satirlar[3]["veri3"];
      isiSensAdet = satirlar[3]["veri4"];
    }

    if (dbSatirSayisi > 4) {
      bacafanAdet = satirlar[4]["veri1"];
      airinletAdet = satirlar[4]["veri2"];
      isiticiAdet = satirlar[4]["veri3"];
      siloAdet = satirlar[4]["veri4"];
    }
